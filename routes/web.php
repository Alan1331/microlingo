...
Route::middleware(CheckFirebaseRole::class)->group(function () {
    ...
    Route::get('/levels/form/{unitId}', [LevelController::class, 'showLevelForm'])->name('units.levels.form');
    ...
    Route::post('/levels/{levelId}/toggle-status', [LevelController::class, 'toggleStatus'])->name('units.levels.toggleStatus');
